...
public class AfproevFravaersSystem {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Antal elever uden fravær: " + karakterSystem.antalUdenFravaer(fravaer18V));
        System.out.println();
        System.out.println("Elev med mest mest fravær er elev nummer " + karakterSystem.mestFravaer(fravaer18V));
        System.out.println();
